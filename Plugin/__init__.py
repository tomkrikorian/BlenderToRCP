...
if bpy is not None:
    ...
    from . import live_preview as live_preview_module
else:
    prefs_module = None
    ui_module = None
    ops_module = None
    live_preview_module = None
...
if bpy is not None and _needs_reload:
    ...
    live_preview_module = importlib.reload(live_preview_module)
...
def unregister():
    ...
    live_preview_module.unregister()
