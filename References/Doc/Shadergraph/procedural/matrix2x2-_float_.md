Source: https://developer.apple.com/documentation/shadergraph/procedural/matrix2x2-(float)
...
## [Overview](https://developer.apple.com/documentation/shadergraph/procedural/matrix2x2-(float)#overview)

(Row-major order.)

## [Parameter Types](https://developer.apple.com/documentation/shadergraph/procedural/matrix2x2-(float)#Parameter-Types)
...
### [Nodes](https://developer.apple.com/documentation/shadergraph/procedural/matrix2x2-(float)#Nodes)
