Source: https://developer.apple.com/documentation/shadergraph/procedural/matrix3x3-(float)
...
## [Overview](https://developer.apple.com/documentation/shadergraph/procedural/matrix3x3-(float)#overview)

(Row-major order.)

## [Parameter Types](https://developer.apple.com/documentation/shadergraph/procedural/matrix3x3-(float)#Parameter-Types)
...
### [Nodes](https://developer.apple.com/documentation/shadergraph/procedural/matrix3x3-(float)#Nodes)
