Source: https://developer.apple.com/documentation/shadergraph/realitykit/cube-image-gradient-(realitykit)
...
## [Overview](https://developer.apple.com/documentation/shadergraph/realitykit/cube-image-gradient-(realitykit)#overview)

Level of detail gradient. Input image must be in KTX file format

## [Parameter Types](https://developer.apple.com/documentation/shadergraph/realitykit/cube-image-gradient-(realitykit)#Parameter-Types)
...
## [Parameter descriptions](https://developer.apple.com/documentation/shadergraph/realitykit/cube-image-gradient-(realitykit)#Parameter-descriptions)
...
:   The minimum level of detail allowed for the rendered image contents. Similar to the `Min Lod Clamp` parameter, except you can change this parameter dynamically at runtime.

`Gradientcube D Pdx`
:   The rate of change of the surface geometry in the X direction of the sampled surface or texture.

`Gradientcube D Pdy`
:   The rate of change of the surface geometry in the Y direction of the sampled surface or texture.

## [Discussion](https://developer.apple.com/documentation/shadergraph/realitykit/cube-image-gradient-(realitykit)#Discussion)
...
`clamp_to_edge`
:   The node clamps texture coordinates outside the normal range to the normal range. The node sets any values greater than `1` to `1`, and any values less than `0` to `0`. This means the colors on the edge of the image extend to fill the rest of the texture.
...
For an example of how to use this node, see [`Cube Image (RealityKit)`](https://developer.apple.com/documentation/shadergraph/realitykit/cube-image-(realitykit)).

### [Nodes](https://developer.apple.com/documentation/shadergraph/realitykit/cube-image-gradient-(realitykit)#Nodes)
