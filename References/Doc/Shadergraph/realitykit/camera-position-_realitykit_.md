Source: https://developer.apple.com/documentation/shadergraph/realitykit/camera-position-(realitykit)
...
## [Parameter Types](https://developer.apple.com/documentation/shadergraph/realitykit/camera-position-(realitykit)#Parameter-Types)
...
## [Parameter description](https://developer.apple.com/documentation/shadergraph/realitykit/camera-position-(realitykit)#Parameter-description)

`Space`
:   The space that establishes the camera’s position. This parameter can be equal to `world`, `tangent`, `object`, or `model`. The default value is `world`.

### [Nodes](https://developer.apple.com/documentation/shadergraph/realitykit/camera-position-(realitykit)#Nodes)
