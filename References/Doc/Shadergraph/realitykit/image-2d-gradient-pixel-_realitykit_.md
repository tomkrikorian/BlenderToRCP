Source: https://developer.apple.com/documentation/shadergraph/realitykit/image-2d-gradient-pixel-(realitykit)
...
## [Overview](https://developer.apple.com/documentation/shadergraph/realitykit/image-2d-gradient-pixel-(realitykit)#overview)

Level of detail gradient. Pixel texture coordinates

## [Parameter Types](https://developer.apple.com/documentation/shadergraph/realitykit/image-2d-gradient-pixel-(realitykit)#Parameter-Types)
...
## [Parameter descriptions](https://developer.apple.com/documentation/shadergraph/realitykit/image-2d-gradient-pixel-(realitykit)#Parameter-descriptions)
...
## [Discussion](https://developer.apple.com/documentation/shadergraph/realitykit/image-2d-gradient-pixel-(realitykit)#Discussion)
...
### [Nodes](https://developer.apple.com/documentation/shadergraph/realitykit/image-2d-gradient-pixel-(realitykit)#Nodes)
