Source: https://developer.apple.com/documentation/shadergraph/realitykit/multiply-24-(realitykit)
...
## [Overview](https://developer.apple.com/documentation/shadergraph/realitykit/multiply-24-(realitykit)#overview)

X and Y are 32-bit integers but only the low 24 bits perform the multiplication

## [Parameter Types](https://developer.apple.com/documentation/shadergraph/realitykit/multiply-24-(realitykit)#Parameter-Types)
...
### [Nodes](https://developer.apple.com/documentation/shadergraph/realitykit/multiply-24-(realitykit)#Nodes)
