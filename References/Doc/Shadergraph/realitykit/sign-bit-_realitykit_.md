Source: https://developer.apple.com/documentation/shadergraph/realitykit/sign-bit-(realitykit)
...
## [Overview](https://developer.apple.com/documentation/shadergraph/realitykit/sign-bit-(realitykit)#overview)

Returns true if the sign bit is set for the value in X, otherwise returns false

## [Parameter Types](https://developer.apple.com/documentation/shadergraph/realitykit/sign-bit-(realitykit)#Parameter-Types)
...
### [Nodes](https://developer.apple.com/documentation/shadergraph/realitykit/sign-bit-(realitykit)#Nodes)
