Source: https://developer.apple.com/documentation/shadergraph/2d-procedural/split-horizontal
...
## [Parameter Types](https://developer.apple.com/documentation/shadergraph/2d-procedural/split-horizontal#Parameter-Types)
...
## [Parameter descriptions](https://developer.apple.com/documentation/shadergraph/2d-procedural/split-horizontal#Parameter-descriptions)
...
`Center`
:   The V value at which the output is split. Everything above this value is equal to the `Top` input; everything below this value is equal to the `Bottom` input. This parameter ranges between `0` and `1`.
...
## [Discussion](https://developer.apple.com/documentation/shadergraph/2d-procedural/split-horizontal#Discussion)
...
### [Nodes](https://developer.apple.com/documentation/shadergraph/2d-procedural/split-horizontal#Nodes)
